...
<html lang="en">
	<head>
		...
		<meta name="author" content="Chris Reed, based on works by Pascal van Gemert" />
		...
		<title>Chris Reed - Seasoned IT Professional - Interactive Resume</title>
		...
		<script type="text/javascript" id="inspectletjs">
			...
			(function() {
				function __ldinsp(){var insp = document.createElement('script'); insp.type = 'text/javascript'; insp.async = true; insp.id = "inspsync"; insp.src = ('httpss:' == document.location.protocol ? 'httpss' : 'https') + '://www.inspectlet.com/inspectlet.js'; var x = document.getElementsByTagName('script')[0]; x.parentNode.insertBefore(insp, x); }
