...
<html lang="en">
	<head>
		...
		<meta name="author" content="Chris Reed" />
		<meta name="description" content="I'm Chris Reed, a ninja webdeveloper / creative programmer with good knowledge of front-end technics." />
		<meta name="keywords" content="Chris Reed, Interactive Resume, PHP programmer, Web developer, Startup, Interactive CV, Resume, CV, Whoopaa, HRMatches, Sanitairwinkel, Algorithms, PHP, MySQL, OOP" />
		<meta name="robots" content="index, follow" />
		<meta name="revisit-after" content="14 days" />
			
		<title>Chris Reed - Web Developer - Interactive Resume</title>
		...
		<link href="<?= VIEW_PATH; ?>css/style.css" rel="stylesheet" />
	...
	<body data-spy="scroll" data-target="#navbar-example">
		...
		<?php 
			...
			$header_images = array(
				array('source' => VIEW_PATH.'images/monday.jpg', 'position' => 'center center'),
				array('source' => VIEW_PATH.'images/tuesday.jpg', 'position' => 'center right'),
				array('source' => VIEW_PATH.'images/wednesday.jpg', 'position' => 'center center'),
				array('source' => VIEW_PATH.'images/thursday.jpg', 'position' => 'center right'),
				array('source' => VIEW_PATH.'images/friday.jpg', 'position' => 'center right'),
				array('source' => VIEW_PATH.'images/saturday.jpg', 'position' => 'bottom right'),
				array('source' => VIEW_PATH.'images/sunday.jpg', 'position' => 'center center')
			);
			...
			if(date('d-m') == '11-03')
			{
				$current_header = array('source' => VIEW_PATH.'images/birthday.jpg', 'position' => 'center center');
			}
		?>
